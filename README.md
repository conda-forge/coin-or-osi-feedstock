...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/coin-or-osi-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/coin-or-osi-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add coin-or-osi
# for installing globally
pixi global install coin-or-osi
```
...
It is possible to list all of the versions of `coin-or-osi` available on your platform:
...
```
pixi search coin-or-osi --channel conda-forge
```
